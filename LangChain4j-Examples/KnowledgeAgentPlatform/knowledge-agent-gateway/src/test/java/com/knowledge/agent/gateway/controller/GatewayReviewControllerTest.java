...
class GatewayReviewControllerTest {
    ...
    void shouldReturnManualReviewTaskBatchForAuthenticatedUser() {
        ...
        GatewayReviewController controller = new GatewayReviewController(dispatcher);
    ...
    void shouldDelegateReviewStatusUpdate() {
        ...
        GatewayReviewController controller = new GatewayReviewController(mock(ReviewTaskDispatcher.class));
